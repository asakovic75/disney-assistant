...
if knowledge_base_text and GROQ_API_KEY:
    try:
        ...
        # Используем мощную модель для лучшего следования инструкциям
...
ОТВЕТ:"""
                ...
                try:
                    # Пытаемся разделить на техническую часть и ответ
                    if "[ОТВЕТ]" in answer:
                    ...
                    # Увеличиваем размер эмодзи названия для красоты
                    ...
                    # Если формат сломался, выводим как есть
