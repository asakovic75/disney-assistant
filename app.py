...
3.  **ФОРМАТ ОТВЕТА (ОБЯЗАТЕЛЬНО):** Твой ответ ДОЛЖЕН состоять из двух блоков: `[РАССУЖДЕНИЯ]` и `[ОТВЕТ]`.
    -   **В блоке `[РАССУЖДЕНИЯ]`:** Сначала **процитируй все релевантные записи из 'Данных'**, которые ты будешь использовать. Затем, опираясь на эти цитаты, кратко объясни свой вывод.
    -   **В блоке `[ОТВЕТ]`:** Сформулируй финальный, чистый ответ для пользователя.

ПРИМЕР ФОРМАТА:
[РАССУЖДЕНИЯ]
Вопрос касается бюджета 'Короля Льва'. Я нашел следующую запись в данных:
-----
Название: Король лев
